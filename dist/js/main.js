(function($) {
    ...
    $(function() {
        ...
        function openAccordion(box) {
            // $('html,body').animate({scrollTop: $(box).offset().top - $('.navbar').innerHeight()},'slow');
